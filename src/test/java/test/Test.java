...
public class Test {
    ...
    private String randomTitleString = randomStringGenerator.generate(lengthOfTitleString);
    private String randomBodyString = randomStringGenerator.generate(lengthOfBodyString);
    private Map<String, String> values = MapUtils.getMap(randomTitleString, randomBodyString, JsonUtils.getValueFromTestDataJson("/userIdToPostAPI"));
    ...
    @org.testng.annotations.Test
     public void test() throws UnirestException {
        ...
        Assert.assertTrue(APIUtils.checkingSort(responseOfPorts), "Values by id are not sorted");
        ...
        int index = APIUtils.findElementOfListById(responseOfUsers, JsonUtils.getValueFromConfigJson("/usersIdValue"));
